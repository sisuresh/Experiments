...
- Make the umbrella **`next` ENABLE every in-flight cap**: `next = ["soroban-env-macros/next", "cap_0084_muxed_contract", ...]` in `soroban-env-common`, and forward plain `next = ["soroban-env-common/next"]` through host/guest.
